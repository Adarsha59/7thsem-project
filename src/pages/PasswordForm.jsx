...
const PasswordForm = ({ name, onSubmit, loading }) => {
  ...
  return (
    ...
    >
      ...
      >
        {loading || isSubmitting.current ? "Registering..." : "Submit"}
      </button>
    </form>
  );
};
